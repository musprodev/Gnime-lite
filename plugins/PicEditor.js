...
Module_Exports({ kingcmd: "ad", kingclass: "image editor commands", kingpath: __filename,  infocmd: "pic Editor."},
...
//=============================================================================
Module_Exports({ kingcmd: "jail", kingclass: "image editor commands", kingpath: __filename,  infocmd: "pic Editor."},
...
//=============================================================================
Module_Exports({ kingcmd: "uncover", kingclass: "image editor commands", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "clown", kingclass: "image editor commands", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "mnm", kingclass: "image editor commands", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "pett", kingclass: "image editor commands", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "greyscale", kingclass: "image editor commands", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "invert", kingclass: "image editor commands", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "blur", kingclass: "image editor commands", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//============================================================================
Module_Exports({ kingcmd: "drip", kingclass: "image editor commands", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "colorify", kingclass: "image editor commands", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "gun", kingclass: "image editor commands", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
...
//=============================================================================
Module_Exports({ kingcmd: "wanted", kingclass: "image editor commands", kingpath: __filename,  infocmd: "pic Editor."},
async(sigma, man, text) => {
    if (!man.quoted) return await man.reply(`*_Reply To An Image_*`);
    if(man.quoted.mtype !='imageMessage') return await man.reply("_You Idiot Reply To An Image_");
