...
Module_Exports({
        ...
        async(sigma, citel, text) => {
            if (isNaN(text.split(" ")[0]) || !text) {
                let text = tiny(
                    `*_fancy text generator_*\n✧━━━━━━━━━━━━━━━━━━━━━✧\n*example: ${prefix}fancy 32 _gnime_*\n✧━━━━━━━━━━━━━━━━━━━━━✧\n\n`
                );
...
return citel.reply(a,{packname:'GNIME-MD',author:'Astro'},"sticker") 
...
return citel.reply(a,{packname:'GNIME_MD',author:'aSTRO'},"sticker") 
