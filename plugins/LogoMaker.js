...
//-----------------------------------------------------------------------------------
Module_Exports({ kingcmd: "slice", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-----------------------------------------------------------------------------------
Module_Exports({ kingcmd: "glow", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//----------------------------------------------------------------------------------- 
Module_Exports({ kingcmd: "glittch", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//---------------------------------------------------------------------------
//================================================================================================================================
Module_Exports({ kingcmd: "stel",alias:['steal'],kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-----------------------------------------------------------------------------------
Module_Exports({ kingcmd: "avenger",kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-----------------------------------------------------------------------------------
Module_Exports({ kingcmd: "marvel",kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-----------------------------------------------------------------------------------
Module_Exports({ kingcmd: "phub",kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "glitch3",kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-----------------------------------------------------------------------------------
Module_Exports({ kingcmd: "glitch2",kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-----------------------------------------------------------------------------------
Module_Exports({ kingcmd: "grafiti",kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//================================================================================================================================
    //---------------------------------------------------------------------------
    Module_Exports({ kingcmd: "deepsea", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "horror", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "whitebear", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "joker", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "metallic", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "steel", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "harrypotter", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "underwater", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "luxury", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "glue", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "fabric", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "toxic", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "ancient", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "cloud", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "transformer", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "thunder", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "scifi", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({kingcmd: "sand", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "rainbow", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "pencil", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "neon2", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({kingcmd: "magma", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "leaves", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "glitch", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
            if (!text) return citel.reply(`*_Example: ${prefix}glitch Zubair_*`)
            return await singleText(Void, citel , 'create-impressive-glitch-text-effects-online-1027' , text )
        })
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "discovery", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "christmas", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "candy", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "1917", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
Module_Exports({ kingcmd: "blackpink", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-------------------------------------------------------------------------------
Module_Exports({ kingcmd: "neon", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-------------------------------------------------------------------------------
Module_Exports({ kingcmd: "summer", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
//-------------------------------------------------------------------------------
Module_Exports({ kingcmd: "pixel", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "2024", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "newyear", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "party", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "valentine", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "frozen", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "golden",kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "glass", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "deluxe", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "captain",kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
...
Module_Exports({ kingcmd: "black", kingclass: "logo maker", infocmd: "Some text to image feature with various styles.",kingpath: __filename, }, async(Void, citel, text) => {
